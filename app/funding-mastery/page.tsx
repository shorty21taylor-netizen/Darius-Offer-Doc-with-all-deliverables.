        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            <div className="pricing-card">
              ...
              <div className="pricing-amount"><span className="pricing-currency">$</span><span className="pricing-value">3,500</span></div>
              ...
              <a href="https://www.fanbasis.com/agency-checkout/Dariusbenders/PZRW" target="_blank" className="cta-button" style={{ textDecoration: "none" }}>Get Started</a>
            </div>
            <div className="pricing-card featured">
              ...
              <div className="pricing-amount"><span className="pricing-currency">$</span><span className="pricing-value">6,500</span><span className="pricing-range">– $8,500</span></div>
              <ul className="pricing-features">
              ...
              <a href="https://www.fanbasis.com/agency-checkout/Dariusbenders/p87y" target="_blank" className="cta-button" style={{ textDecoration: "none" }}>Get Started</a>
            </div>
          </div>
        </div>
      </section>
